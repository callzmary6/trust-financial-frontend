...
import { cryptoOptions, megaPlans } from "../data/investmentPlans";
...
.refine((data) => {
  const selectedPlan = megaPlans.find(
...
export default function DepositForm() {
  ...
  const onSubmit: SubmitHandler<DepoData> = async (data: DepoData) => {
    ...
    const newUrl = `${window.location.pathname}?mega=true`;
